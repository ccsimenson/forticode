...
exports.ConfigFileValidationCheck = exports.ElectronSecurityCheck = exports.NodeSecurityCheck = exports.DependencyCheck = exports.SecurityHeadersCheck = void 0;
const vulnerability_service_1 = require("./vulnerability-service");
const child_process_1 = require("child_process");
const fs_1 = require("fs");
class SecurityHeadersCheck {
    constructor() {
        this.name = 'Security Headers Validation';
    }
    async run() {
        try {
            const headers = {
...
exports.SecurityHeadersCheck = SecurityHeadersCheck;
class DependencyCheck {
    constructor() {
        this.name = 'Dependency Vulnerability Scan';
        this.vulnerabilityService = vulnerability_service_1.VulnerabilityService.getInstance();
    }
    async run() {
        try {
            // Get npm audit vulnerabilities
            const npmAuditResult = await (0, child_process_1.execSync)('npm audit --json', { encoding: 'utf-8' });
            const npmAudit = JSON.parse(npmAuditResult);
            const npmVulnerabilities = [];
            ...
            const packageList = JSON.parse((0, child_process_1.execSync)('npm list --json', { encoding: 'utf-8' }));
            ...
            const uniqueVulnerabilities = Array.from(new Map(allVulnerabilities.map(vuln => [vuln.id, vuln])).values());
            return {
                name: this.name,
...
class NodeSecurityCheck {
    constructor() {
        this.name = 'Node.js Security Configuration';
    }
    async run() {
        try {
...
exports.NodeSecurityCheck = NodeSecurityCheck;
class ElectronSecurityCheck {
    constructor() {
        this.name = 'Electron Security';
        this.vulnerabilityService = vulnerability_service_1.VulnerabilityService.getInstance();
    }
    async run() {
        try {
    ...
    async checkPackageDependencies() {
        try {
            const result = (0, child_process_1.execSync)('npm list --json', { encoding: 'utf-8' });
            const packageList = JSON.parse(result);
            const dependencies = {};
            const processDependencies = (deps, path = []) => {
...
exports.ElectronSecurityCheck = ElectronSecurityCheck;
class ConfigFileValidationCheck {
    constructor(vulnerabilityService) {
        this.name = 'Configuration File Validation';
...
exports.ConfigFileValidationCheck = ConfigFileValidationCheck;
